...
read -p "Are you sure you want to save the uncommitted changes to the diff saved at /var/tmp/changes.diff? This will overwrite any uncommitted changes. (y/n): " confirm
